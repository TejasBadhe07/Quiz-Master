            ...
            {categories.map((category, index) => (
              ...
              >
                <button
                  ...
                  className={`w-full p-8 rounded-2xl bg-gradient-to-br ${category.color} text-white transform transition-all duration-300 hover:scale-105 hover:shadow-xl`}
                >
                  ...
                  <p className="text-white/80">Test your knowledge in this category</p>
                </button>
              </motion.div>
            ))}
          </div>
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-4">
                <motion.button
                  ...
                  onClick={resetQuiz}
                  className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-3 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  Play Again
                </motion.button>
                <motion.button
                  ...
                  onClick={resetQuiz}
                  className="bg-white text-purple-600 border-2 border-purple-600 px-8 py-3 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  Choose Category
                </motion.button>
              </div>
        ...
        >
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center">
              ...
              <h2 className="text-xl font-semibold text-gray-800">{currentCategory.name}</h2>
            </div>
